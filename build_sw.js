...
self.addEventListener('install', function (event) {
  event.waitUntil(caches.open(staticCacheName).then(function (cache) {
    return cache.addAll(['/', '/dist/build.js', '/dist/build_restaurant.js', '/css/styles.css']);
  }));
});
    ...
    if (requestUrl.pathname === '/restaurants') {
      ...
      if (navigator.onLine) {
        event.respondWith(fetch(event.request).then(function (res) {
          var originalResponse = res.clone();
          return res.json().then(function (restaurants) {
            return addRestaurantsToDatabase(restaurants);
          }).then(function () {
        ...
        event.respondWith(dbPromise.then(function (db) {
          return db.transaction('restaurants').objectStore('restaurants').getAll().then(function (res) {
...
var addRestaurantsToDatabase = function addRestaurantsToDatabase(restaurants) {
...
//# sourceMappingURL=build_sw.js.map
